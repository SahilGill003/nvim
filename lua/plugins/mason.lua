return {
  ...
  dependencies = {
    ...
    },
    {
      ...
      opts = {
        ...
        automatic_installation = { exclude = table.insert(require("utils").lservers, require("utils").servers) },
      },
    },
    {
      "folke/neodev.nvim",
  ...
  config = function()
    ...
    local on_attach = function(_, bufnr)
      ...
      vim.keymap.set("n", "<leader>lr", require("telescope.builtin").lsp_references, attach_opts)
      vim.keymap.set("n", "<leader>td", require("telescope.builtin").diagnostics, attach_opts)
